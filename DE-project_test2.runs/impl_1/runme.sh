...
HD_PWD='C:/Users/revan/DE-project_test2/DE-project_test2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SafeStartupSequence.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SafeStartupSequence.tcl -notrace
