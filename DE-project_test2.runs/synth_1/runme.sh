...
HD_PWD='C:/Users/revan/DE-project_test2/DE-project_test2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SafeStartupSequence.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SafeStartupSequence.tcl
